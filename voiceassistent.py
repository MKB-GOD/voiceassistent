...
while True:
    ...
    if "wikipedia" in command:
        ...
        my_screenshot = pyaudio.screenshot()
        ...
        print("Hello. I am version 1 of the voice assistant and was programmed by MKB-GOD.\n")
        speak("Hello. I am version 1 of the voice assistant and was programmed by MKB-GOD.")
